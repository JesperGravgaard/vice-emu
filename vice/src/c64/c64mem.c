...
static const int banknums[NUM_BASE_BANKS + 1] = { 0, 0, 1, 2, 3, 4, -1 };
static const int bankindex[NUM_BASE_BANKS + 1] = { -1, -1, -1, -1, -1, -1, -1 };
static const int bankflags[NUM_BASE_BANKS + 1] = { 0, 0, 0, 0, 0, 0, -1 };
